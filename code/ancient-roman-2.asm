.psx
.open "cd\Ancient-Roman-Disc-2\CODE.DAT",0x801E1000
...
.definelabel FUN_8003dc00, 0x8003dc00 ; Unused
.definelabel DisplayString, 0x800570f8
.definelabel PlayAudio, 0x80045784
.definelabel MemoryAllocate, 0x800457c4
...
.definelabel activeBuffer, 0x8011cce4
...
.org 0x8004ff24	; Update x placement of spells/items in battle menu
	li a0,-0x44
	
.org 0x800596e0	; Update highlight width of spells/items in battle menu
	li v0, 0x3e
...
.org 0x8009D654 ; Item cost x position
	.db 0x65
.org 0x8009D678 ; Item cost x position
	.db 0x65
.org 0x8009D69C ; Item cost x position
	.db 0x65
.org 0x8009D6C0 ; Item cost x position
	.db 0x65
.org 0x8009D6E4 ; Item cost x position
	.db 0x65

.org 0x8009D618 ; Gahme x position
	.db 0x97	
.org 0x8009D63c
	.db 0x97
.org 0x8009D660
